...
void modifyInput(Input &input) {
    input.rules.insert_or_assign(8,
        Rule{
            RuleOption{RuleItem{false, 0, 42}},
            RuleOption{RuleItem{false, 0, 42}, RuleItem{false, 0, 8}}
        }
    );
    input.rules.insert_or_assign(11,
        Rule{
            RuleOption{RuleItem{false, 0, 42}, RuleItem{false, 0, 31}},
            RuleOption{RuleItem{false, 0, 42}, RuleItem{false, 0, 11}, RuleItem{false, 0, 31}}
        }
    );
}
...
int main(void) {
    Input input = readParseInput("../input/day19.txt");
    modifyInput(input);
